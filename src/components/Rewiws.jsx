...
const Rewiws = () => {
    return (
        ...
        <div className="flex flex-col max-w-xl p-8 rounded-xl lg:p-12 justify-center mx-auto shadow-xl">
    ...
    <div className="flex flex-col max-w-xl p-8  rounded-xl lg:p-12 shadow-xl justify-center mx-auto">
        <div className="flex flex-col w-full">
            <h2 className="text-3xl font-semibold text-center">Customer reviews</h2>
            <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
                <div className="flex">
