        ...
        <div className="bg-[#f9f9f9] justify-around pt-32 items-center mx-auto">
            ...
            <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                ...
                <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                    ...
                    <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
                        <img src="https://i.ibb.co/jkPktgz/1-e35958cd-3f41-4262-85ab-017f8a776679-600x.webp"  alt="" className="w-16 h-16 mb-2 -mt-16 rounded-full  dark:bg-gray-300" />
                ...
                <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                    ...
                    <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-600 dark:text-gray-50">
                        <img src="https://i.ibb.co/SQP93dj/IMG-8117-1.jpg"  alt="" className="w-16 h-16 mb-2 -mt-16 bg-center rounded-full  dark:bg-gray-300" />
